...
saveRows | 保存某些行的数据 | Function(rows: Array&lt;row&gt;)
saveCells | 保存某些单元格的数据 | Function(rows: Array&lt;row&gt;, cells: Array&lt;cell&gt;)
cancelRows | 撤销某些行的编辑状态和数据 | Function(rows: Array&lt;row&gt;)
cancelCells | 撤销某些单元格的编辑状态和数据 | Function(rows: Array&lt;row&gt;, cells: Array&lt;cell&gt;)
